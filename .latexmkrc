...
$pdflatex ='pdflatex -synctex=1 -interaction=nonstopmode --enable-pipes --shell-escape';
...
$pdf_previewer = "/usr/bin/zathura -l error -s -x 'vim --servername TEX --remote +%{line} \"%{input}\"' %O %S" 
